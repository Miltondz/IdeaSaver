...
export const en = {
  ...
  record_no_recording_error: 'Could not find the audio to process.',
  record_empty_audio_error: 'The recording was empty. Please try again.',
  record_mic_access_denied: 'Please allow microphone access in your browser settings to record audio.',
  record_processing_error: 'Could not process the audio. Please try again.',
  record_share_fail: 'Could not share the note. An unexpected error occurred.',
  record_share_not_supported: "This browser doesn't support sharing. The note has been copied to your clipboard instead.",
  record_share_denied: "We couldn't open the share dialog. The note has been copied to your clipboard instead.",
  record_save_cloud_success: 'Your note has been saved to the database.',
  record_save_cloud_fail: 'Could not save to the database.',
  record_discard_success: 'The recording has been successfully deleted.',
  record_discard_fail: 'Could not discard the note. Please try again.',
  ...
  ai_action_project_plan: 'project plan',
  ai_action_tasks: 'task list',
  ...
  settings_credits_remaining: 'You have {credits} AI credits remaining.',
