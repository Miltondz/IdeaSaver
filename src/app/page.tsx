  ...
  return (
    <div className="min-h-screen bg-background flex flex-col items-center justify-center p-4">
      <div className="absolute top-8 flex items-center gap-3">
        ...
        <h1 className="text-4xl font-bold tracking-tight">Audio Capture</h1>
      </div>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
               <div className="space-y-2">
                ...
                <Input id="email-up" type="email" placeholder="m@example.com" />
              </div>
              <div className="space-y-2">
               ...
               <Button asChild className="w-full">
                <Link href="/pricing">Create Account & Choose Plan</Link>
              </Button>
            </CardContent>
          </Card>
        </TabsContent>
